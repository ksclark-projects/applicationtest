...
def print_memory_section(cyan, white):
    ...
    print(f"{cyan}Memory Available:{white} {mem['available_gb']} GB")
    print(f"{cyan}Memory Used:{white} {mem['used_gb']} GB")
...
def print_disk_section(cyan, white):
    ...
    print(f"{cyan}Disk Total:{white} {disk['total_gb']} GB")
    print(f"{cyan}Disk Used:{white} {disk['used_gb']} GB")
